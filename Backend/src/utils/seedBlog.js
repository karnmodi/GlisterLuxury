...
const blogData = [
	{
		...
		content: `A door handle opens experiences. At Glister London, we see every handle as a silent witness to life — to morning light, warm laughter, quiet goodbyes. We believe emotion can live in metal.`,
		tags: ['Emotion in Design', 'Door Handles', 'Luxury Craft'],
		seoTitle: 'The Handle That Holds Emotion | Glister London',
		seoDescription: 'Discover how Glister London transforms hardware into emotion — the art of design you can feel.',
		order: 0,
		isActive: true,
	},
	{
		...
		seoTitle: 'Brass Finishes with Soul | Glister London',
		seoDescription: 'Experience the living beauty of solid brass hardware that grows richer with time.',
		order: 1,
		isActive: true,
	},
	{
		title: 'The House of Heritage — Inside Glister London',
		shortDescription: 'Step into the world where British craftsmanship and modern design converge.',
		content: `In an age of mass-production, Glister London stands for the art of the made-to-last. Every creation begins as a sketch, then shaped by craftsmen who believe precision is poetry.`,
		tags: ['Craftsmanship', 'Heritage', 'British Design'],
		seoTitle: 'British Heritage Craftsmanship | Glister London',
		seoDescription: 'Discover the world of Glister London — a house built on British artistry and emotion-driven design.',
		order: 2,
		isActive: true,
	},
	{
		...
		seoTitle: 'Luxury Hardware Finishes | Glister London',
		seoDescription: 'Explore Glister London\'s curated palette of premium finishes — designed for royalty, built for life.',
		order: 3,
		isActive: true,
	},
	{
		...
		content: `Pride of a home lies in how it feels. Every Glister London piece carries a part of our soul, shaped with intent, finished with care, destined to become part of yours.`,
		tags: ['Home Pride', 'Emotional Design', 'British Luxury'],
		seoTitle: 'Pride & Emotion in Design | Glister London',
		seoDescription: 'Experience the emotion behind every Glister London creation — the pride of true craftsmanship.',
		order: 4,
		isActive: true,
	},
];
